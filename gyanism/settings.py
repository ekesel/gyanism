...
ALLOWED_HOSTS = ['*'] #gyanism.in','www.gyanism.in
...
WSGI_APPLICATION = 'gyanism.wsgi.application'
...
# https://docs.djangoproject.com/en/2.2/howto/static-files/
 #'/home/khswefxb/public_html/static'
#'/home/khswefxb/public_html/media'
